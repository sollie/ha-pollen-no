...
class TestCoordinatorUpdate:
    async def test_returns_full_pollen_data(self, mock_api):
        coord = _make_coordinator(mock_api)
        data = await coord._async_update_data()
        assert data["pollen"] == MOCK_COMBINED_DATA["pollen"]
        assert data["forecast"] == MOCK_COMBINED_DATA["forecast"]
